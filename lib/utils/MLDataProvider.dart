...
import 'package:mediab/components/MLClinicVisitComponent.dart';
import 'package:mediab/components/MLConfirmAppointmentComponent.dart';
import 'package:mediab/components/MLDoctorListComponent.dart';
import 'package:mediab/components/MLHospitalListComponent.dart';
import 'package:mediab/components/MLPatientComponent.dart';
import 'package:mediab/model/MLAppointmentData.dart';
import 'package:mediab/model/MLBookAppointmentData.dart';
import 'package:mediab/model/MLCovidData.dart';
import 'package:mediab/model/MLDeliveredData.dart';
import 'package:mediab/model/MLDepartmentData.dart';
import 'package:mediab/model/MLDiseaseData.dart';
import 'package:mediab/model/MLDoctorData.dart';
import 'package:mediab/model/MLInboxData.dart';
import 'package:mediab/model/MLMedicationData.dart';
import 'package:mediab/model/MLNewsData.dart';
import 'package:mediab/model/MLNotificationData.dart';
import 'package:mediab/model/MLOrderSuccessData.dart';
import 'package:mediab/model/MLOrderTrackData.dart';
import 'package:mediab/model/MLPatientData.dart';
import 'package:mediab/model/MLPaymentData.dart';
import 'package:mediab/model/MLProfileCardData.dart';
import 'package:mediab/model/MLServiceData.dart';
import 'package:mediab/model/MLSpecialistData.dart';
import 'package:mediab/model/MLTopHospitalData.dart';
import 'package:mediab/model/MLVoucherData.dart';
import 'package:mediab/model/MLWalkThroughData.dart';
import 'package:mediab/screens/MLBookAppointmentScreen.dart';
import 'package:mediab/screens/MLCovid19Screen.dart';
import 'package:mediab/screens/MLDiseaseScreen.dart';
import 'package:mediab/screens/MLOnlinePharmacyScreen.dart';
import 'package:mediab/screens/MLVideoCounsultScreen.dart';
...
List<MLPaymentData> mlPaymentDataList() {
  ...
  list.add(
    MLPaymentData(
      image: ml_ic_bank_payment_one,
      title: 'Payment at the clinic',
    ),
  );
  list.add(
    MLPaymentData(image: ml_ic_bank_payment_two, title: '**** **** **** 2109'),
  );
  list.add(
    MLPaymentData(
      image: ml_ic_bank_payment_three,
      title: '**** **** **** 1210',
    ),
  );
...
List<MLOrderSuccessData> mlOrderSuccessDataList() {
  ...
  list.add(
    MLOrderSuccessData(
      title: 'An email confirmation will sent to',
      data: 'tmrw@gmail.com',
    ),
  );
  list.add(MLOrderSuccessData(title: 'Code Order', data: '#2995451'));
