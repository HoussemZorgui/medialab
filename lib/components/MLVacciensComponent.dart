...
import 'package:mediab/components/MLCovidTopRegionComponent.dart';
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(
                      '3.6%',
                      style: boldTextStyle(color: Colors.greenAccent, size: 20),
                    ),
                    4.height,
                ...
                Column(
                  ...
                  children: [
                    Text(
                      '7.8%',
                      style: boldTextStyle(color: Colors.cyanAccent, size: 20),
                    ),
                    4.height,
                    Text(
                      'Received atleast one dose',
